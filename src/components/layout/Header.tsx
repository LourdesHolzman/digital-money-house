        ...
        <div className="flex h-16 items-center justify-between">
          ...
          {user && (
            <div className="flex items-center space-x-3">
              <Link href="/profile">
                <div className="px-3 py-1 bg-dmh-primary rounded-lg flex items-center justify-center text-dmh-secondary font-bold text-sm cursor-pointer hover:bg-dmh-primary-dark transition-colors">
